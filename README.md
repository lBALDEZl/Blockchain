...
- Lista encadeada: É utilizada para organizar os blocos da blockchain.
- Função HASH: É utilizada para o encadeamento entre blocos e também para garantir a integridade destes blocos.
